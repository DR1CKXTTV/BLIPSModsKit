...
Config.Map = {
  {name="~b~Maison ~r~Derek ~w~& ~r~Brian",color=59, id=492, x = -2610.03,  y = 1692.92,  z = 142.66474914551},
  --{name="~b~Maison ~y~Rock Norris",color=0, id=206, x = 956.657, y = 447.009, z = 122.800},
